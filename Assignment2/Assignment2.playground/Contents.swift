...
/*  a generic type to be declared when passed a variable (Int, Int)
...
/* the neighboring cells relative to a given cell
...
/*
        The return type is already determined as Int not a generic as in map2
 */
...
/*  when row or col are of an wrong type
...
/*
        neighboring cells associated in the isAlive state
 */
...
/*
    returns a given cell's position i.e. row and col position
 */
...
/*  the state of the upcoming cell i.e. empty, alive, born, died
